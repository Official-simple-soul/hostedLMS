    ...
    >
      <div className="content h-[100%] overflow-auto">
        ...
        <div className="flex justify-start items-center px-5  mt-4 space-x-8">
          ...
          <h2 className={`${allArchive==='Archive'?'border-b-2 border-black':'border-none text-blue-ribbon-400'} cursor-pointer`} onClick={(e)=> setAllArchive(e.currentTarget.innerHTML)}>Archive</h2>
        </div>
        <div className="">
          <ul className="pb-8">
            {
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="text">
                      ...
                      <small className="text-sm text-[grey]">25 min ago</small>
