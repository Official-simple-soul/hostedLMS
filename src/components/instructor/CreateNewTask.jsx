      ...
      <form onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5 md:flex-row md:items-center justify-between mt-2'>
          ...
          <div className='flex items-center gap-2'>
            <button className='border border-[#585858] bg-white py-[1px] px-4 md:px-4 md:py-2 rounded-lg text-base'>
              Cancel
            </button>
            {!isPending && (
              <button className='bg-blue-ribbon-500 py-[1px] px-4 md:px-4 md:py-2 rounded-lg text-white text-base'>
                Create Task
              </button>
            )}
          </div>
            ...
            <div>
              {addResources ? (
                ...
                addResources.map((item) => {
                  return (
                    <li
                      className='my-3 border border-2 py-2 px-2 list-none flex justify-between items-center'
                      key={item.id}
                    >
                      <p>{item.title}</p>
                      <button
                        className='text-[red] font-bold'
                        onClick={() => removeResources(item)}
                      >
                        x
                      </button>
                    </li>
