    ...
    <>
      <div>
        <div className="top">
          ...
          <span>{trainer.name && trainer.name.slice(0,1).toUpperCase()+trainer.name.slice(1)}</span>
        </div>
        <h1 className="text-xl mt-3 mb-6">{trainer.name && trainer.name.slice(0,1).toUpperCase()+trainer.name.slice(1)}</h1>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 mt-8">
          ...
          <div className="right md:col-span-3">
            <ul className="space-y-4">
              ...
              <li className="border-b pb-1 pl-5">{trainer.id && trainer.id}</li>
              <li className="border-b pb-1 pl-5">
                {trainer.gender &&
