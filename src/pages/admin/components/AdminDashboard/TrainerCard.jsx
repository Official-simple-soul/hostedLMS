...
const stage_data = {
  ...
  datasets: [{
      label: 'Poll',
      data: [917,1034, 914, 712, 243, 217],
      backgroundColor: ['#0D6EFD', '#E4E4E4', '#86B6FE', '#FDFEC5', '#AAE9C7', '#303030']
  }]
}
const track_data = {
  labels: [],
  ...
  return (
    <div className="h-[100%] w-full bg-white rounded-xl p-5">
      <div className="flex justify-between items-center">
        <h1>Trainers</h1>
        <select name="" id="" value={selectValue} onChange={(e)=> setSelectValue(e.target.value)} className='text-blue-ribbon-500 px-3 py-1 rounded-md border border-blue-ribbon-300'>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
      {
        ...
        :
        <>
        <Pie data={stage_data} options={options}></Pie>
      <div className="grid grid-cols-2 gap-3 mt-4">
      {
        Data.slice(0,6).map(e=> <h1 className='text-[12px]'>Stage {e.stage} - {e.total}</h1>)
      }
