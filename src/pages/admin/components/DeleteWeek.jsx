    ...
    <div className='flex justify-center items-center w-[100%] h-[100%]'>
        <div className='w-[480px] h-[384px]  rounded-[20px] bg-[#FFFFFF] flex justify-center items-center flex-col px-[60px] pb-[40px] pt-[36.5px]'>
            ...
            <div className="flex mb-[40px] gap-[12px]">
                <button className='w-[114px] h-[54px] bg-[#FFFFFF] text-[#585858]  outline-[0] border-[0] border-[1px] border-[#585858]  rounded-[8px]'>Cancel</button>
                <button className='w-[234px] h-[54px] bg-[#F41717] text-[#FFFFFF]  outline-[0] border-[0] rounded-[8px]'>Yes, delete</button>
            </div>
        </div>
    </div>
  )
