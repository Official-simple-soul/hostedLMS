...
const StudentTask = () => {
  ...
  const changeHandler = (event) => {
    ...
    <div className=''>
        <p className='text-sm mb-2'> <span className='text-blue-400 font-bold'>Tasks /</span>
        <span className='opacity-60'>Redesign KodeCamp Website</span></p>
       ...
       <div className='flex justify-between'>
        <main className='w-[70%] bg-white m-2 p-5 rounded-xl'>
            <div className='flex justify-between'>
            ...
            <div className='flex justify-between my-4 '>
              ...
              <div className='whitespace-nowrap mx-2 opacity-70'>Due in 2 days</div>
              </div>
            ...
            <div className='opacity-70'>
              <p>Design a new website for KodeCamp, taking into consideration the fact that it is an e-learning platform but should also be marketable to sponsors or partners.</p>

              <p className='my-4'>Deliverables:
              ...
              <p>Note that you are to design all pages, not just the home page.</p>
           ...
           <div className='mx-4'>
             <div className=' flex justify-between'>
               ...
               <h4 className={isSubmitted?'text-green-400':'text-red-400'}>
                 {!isSubmitted && <span>Not</span>} Submitted</h4>
             </div>
               <div className=''>
                 <label className='my-2 block opacity-60' htmlFor="link">Link</label>
                 <input className='border-2 rounded-lg w-full px-2 h-[60px]' type="text" placeholder='paste the link to your work'/>
               </div>
               {/* attachment start */}

               <div className='mt-4'>
                 <p className='mb-2 opacity-60'>Attachment</p>
               <div className={isFilePicked? 'hidden border-2 border-dashed border-gray-300 rounded-lg w-full px-2 h-[60px] ' : 'border-2 border-dashed border-gray-300 rounded-lg w-full px-2 h-[60px] '}>
                <label id='customLabel' for='attachment' className='cursor-pointer'  ref={ref}>
                   <input id='inputFile' className='cursor-pointer mb-0 z-0 hidden' type='file' onChange={changeHandler}/>
                   {console.log(selectedFile)}
                   {console.log('is file picked',isFilePicked)}
                   <p  className='mt-4 cursor-pointer'><span className='opacity-60'>Drag & drop or </span><span className='text-blue-600 underline-offset-8'>browse files</span></p>
                </label>

                </div>
                {/* when file is picked */}
                   <div className={isFilePicked? 'border-2 h-[70px] w-full rounded-2xl border-gray-400 flex' : 'hidden'}>
                     <div>
                       <img className='' src={fileIcon} alt="file icon" />
                     </div>
                     <div className='m-4'>
                       {isFilePicked && <p className='opacity-70'>{selectedFile.name}</p>}
                     </div>
                     <div>
                       <img className='mt-4 ml-4 cursor-pointer' src={cancelIcon} alt="cancel" />
                     </div>
               ...
               <div className={isSubmitted?'opacity-30 cursor-not-allowed':''}>
                 <button 
                className={(isFilePicked || isSubmitted) ?'bg-blue-500 rounded-lg w-full h-10 text-white my-4 font-bold':'bg-blue-500 rounded-lg w-full h-10 text-white my-4 font-bold opacity-30 cursor-not-allowed'} 
