  ...
  return (
    <div className="">
      <div className="flex items-center">
        ...
        >
          <div
            className={`${Style.box_shadow} h-full md:h-[90%]  w-full md:rounded-r-3xl flex flex-col justify-center items-center`}
          >
            <div className="flex flex-col gap-4 justify-center items-center">
              ...
              />
              <h2 className={`${Style.col2_text} my-4 text-center`}>
                Log in to dashboard
              </h2>
            </div>
              ...
              <form action="" onSubmit={handleLogin}>
                    ...
                    {showpassword === false ? (
                      <span>
                        <img
                          src={Eye}
                          alt="eye"
                          className="absolute right-3 flex justify-center items-center bottom-3"
                          onClick={toggle}
                        />
                      </span>
                    ) : (
                ...
                <div className="pt-5 pb-12">
                  <p className="text-center">
                    ...
                    <span className={`${Style.login_link} pl-2`}>
