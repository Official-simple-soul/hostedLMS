...
const SignUp2Modal = () => {
  return (
    <div className='modal-bg bg-gray-300 fixed inset-0 flex justify-center items-center z-50 px-4'>
    <div className='modal flex flex-col justify-center items-center p-[30px] md:w-[480px] md:h-[380px] bg-white rounded-lg'>
