...
const Sidebar = () => {
    return (
        <>
            <div className="h-[100%] hidden lg:block relative w-[236px]">
                <div className="bg-white h-full rounded-2xl dark:bg-gray-700">
                    ...
                    <nav className="mt-[4rem]">
                        <div className='relative'>
                            ...
                            <NavLink to='/instructor/profile' className={({ isActive }) => isActive ? "w-full font-thin  text-[#0D6EFD] flex items-center gap-3 p-4 my-2 transition-colors duration-200 justify-start bg-[#0d6efd08] border-r-8 border-[#0D6EFD] dark:from-gray-700 dark:to-gray-800 border-r-8 border-[#0D6EFD]" : "w-full font-thin  text-[#808080] dark:text-gray-200 flex items-center gap-3 p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500 hover:bg-[#0d6efd08]"}>
                                <span className="text-left">
                                    <img src={Student} alt="" className='w-[22px]' />
                                </span>
                                <span className="text-lg font-normal">
                                    Student
                                </span>
                            ...
                            <NavLink to='/instructor/profile' className={({ isActive }) => isActive ? "w-full font-thin  text-[#0D6EFD] flex items-center gap-3 p-4 my-2 transition-colors duration-200 justify-start bg-[#0d6efd08] border-r-8 border-[#0D6EFD] dark:from-gray-700 dark:to-gray-800 border-r-8 border-[#0D6EFD]" : "w-full font-thin uppercase text-[#808080] dark:text-gray-200 flex items-center gap-3 p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500 hover:bg-[#0d6efd08]"}>
                                <span className="text-left">
                            ...
                            <NavLink to='/instructor/profile' className={({ isActive }) => isActive ? "w-full font-thin uppercase text-[#0D6EFD] flex items-center gap-3 p-4 my-2 transition-colors duration-200 justify-start bg-[#0d6efd08] border-r-8 border-[#0D6EFD] dark:from-gray-700 dark:to-gray-800 border-r-8 border-[#0D6EFD]" : "w-full font-thin uppercase text-[#808080] dark:text-gray-200 flex items-center gap-3 p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500 hover:bg-[#0d6efd08]"}>
                                <span className="text-left">
