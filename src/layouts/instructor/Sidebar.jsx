...
const Sidebar = ({showSide, setShowSide}) => {
    ...
    return (
        <>
            <div className={`${showSide?'fixed left-0 h-sreen':'absolute -left-[200%] md:left-0'} overflow-hidden w-[206px] md:w-[236px] transition-all ease-in-out duration-500 top-16 md:top-0 bottom-0 z-40 md:fixed`}>
